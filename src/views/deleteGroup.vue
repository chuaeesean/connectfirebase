        ...
        <div class="card" v-if="contentViewable">
            ...
            <div class="card-body">
                ...
                <p style="font-weight: bold;" v-if="canDelete">
                    The entire group can't be recovered from the moment you deleted it. <a style="cursor: pointer; font-size: 1.5rem;" @click="cancelDelete()" class="link-danger">Press here to cancel</a>
                </p>
                <p v-else>To prevent data-loss, please make sure to delete all the user data in the group before deleting the group. 
                    <a style="cursor: pointer; font-size: 1.5rem;" @click="cancelDelete()" class="link-danger">OK</a>
                </p>
            </div>
        </div>
